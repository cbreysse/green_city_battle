...
event_type2 = EventType.create!(name: "Green Bombing", points: 200, rules: "Végétalisez le nouveau spot en équipe !")
event_type3 = EventType.create!(name: "Green Raid", points: 300, rules: "24h chrono pour faire un max d'actions !")
